package com.allenlabsfsm.features.logoutsync.presentation
...
import com.allenlabsfsm.CustomConstants
...
import com.allenlabsfsm.app.utils.Toaster
import com.allenlabsfsm.base.BaseResponse
import com.allenlabsfsm.base.presentation.BaseActivity
import com.allenlabsfsm.base.presentation.BaseActivity.Companion.compositeDisposable
...
import com.allenlabsfsm.features.billing.api.AddBillingRepoProvider
import com.allenlabsfsm.features.billing.model.AddBillingInputParamsModel
...
import com.allenlabsfsm.features.dashboard.presentation.ReasonDialog
...
import com.allenlabsfsm.features.document.model.AddEditDocumentInputParams
import com.allenlabsfsm.features.document.model.DocumentAttachmentModel
...
import com.allenlabsfsm.features.nearbyshops.api.updateaddress.ShopAddressUpdateRepoProvider
import com.allenlabsfsm.features.nearbyshops.model.updateaddress.AddressUpdateRequest
import com.allenlabsfsm.features.orderhistory.activitiesapi.LocationFetchRepositoryProvider
import com.allenlabsfsm.features.orderhistory.api.LocationUpdateRepositoryProviders
import com.allenlabsfsm.features.orderhistory.model.*
...
import com.allenlabsfsm.features.quotation.model.AddQuotInputModel
import com.allenlabsfsm.features.shopdetail.presentation.api.EditShopRepoProvider
import com.allenlabsfsm.features.shopdetail.presentation.api.addcollection.AddCollectionRepoProvider
import com.allenlabsfsm.features.shopdetail.presentation.model.addcollection.AddCollectionInputParamsModel
import com.allenlabsfsm.features.stock.api.StockRepositoryProvider
import com.allenlabsfsm.features.stock.model.AddStockInputParamsModel
import com.allenlabsfsm.features.stockAddCurrentStock.AddShopStockFragment
import com.allenlabsfsm.features.stockAddCurrentStock.ShopAddCurrentStockList
...
import com.allenlabsfsm.features.stockCompetetorStock.ShopAddCompetetorStockProductList
...
import com.allenlabsfsm.features.timesheet.model.AddTimeSheetInputModel
import com.allenlabsfsm.features.viewAllOrder.api.addorder.AddOrderRepoProvider
import com.allenlabsfsm.features.viewAllOrder.model.AddOrderInputParamsModel
import com.allenlabsfsm.features.viewAllOrder.model.AddOrderInputProductList
import com.allenlabsfsm.mappackage.SendBrod
import com.allenlabsfsm.widgets.AppCustomTextView
import com.allenlabsfsm.MonitorService
import com.allenlabsfsm.MySingleton
...
import com.allenlabsfsm.features.addshop.presentation.ShopExtraContactReq
import com.allenlabsfsm.features.addshop.presentation.multiContactRequestData
import com.allenlabsfsm.features.login.api.LoginRepositoryProvider
import com.allenlabsfsm.features.login.model.GetConcurrentUserResponse
import com.allenlabsfsm.features.login.model.WhatsappApiData
import com.allenlabsfsm.features.performance.model.Gps_status_list
import com.allenlabsfsm.features.performance.model.UpdateGpsInputListParamsModel
import com.allenlabsfsm.features.returnsOrder.ReturnProductList
import com.allenlabsfsm.features.returnsOrder.ReturnRequest
import com.allenlabsfsm.features.viewAllOrder.model.NewOrderSaveApiModel
...
//            checkToCallActivity()
    ...
    private fun callLogshareApi(){
        ...
        if(Pref.LogoutWithLogFile){
            try{
                val filesForZip: Array<String> = arrayOf(File(Environment.getExternalStoragePublicDirectory(Environment.DIRECTORY_DOWNLOADS), "xallenlabsfsmlogsample/log").path)
                ZipOutputStream(BufferedOutputStream(FileOutputStream(File(Environment.getExternalStoragePublicDirectory(Environment.DIRECTORY_DOWNLOADS), "xallenlabsfsmlogsample/log.zip").path))).use { out ->
                ...
                val fileUrl = Uri.parse(File(Environment.getExternalStoragePublicDirectory(Environment.DIRECTORY_DOWNLOADS), "xallenlabsfsmlogsample/log.zip").path);
