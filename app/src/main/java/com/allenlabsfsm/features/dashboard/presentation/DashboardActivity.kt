...
import com.allenlabsfsm.*
import com.allenlabsfsm.R
import com.allenlabsfsm.app.*
import com.allenlabsfsm.app.NewFileUtils.browseDocuments
import com.allenlabsfsm.app.NewFileUtils.getExtension
import com.allenlabsfsm.app.domain.*
import com.allenlabsfsm.app.types.DashboardType
import com.allenlabsfsm.app.types.FragType
import com.allenlabsfsm.app.types.TopBarConfig
import com.allenlabsfsm.app.uiaction.DisplayAlert
import com.allenlabsfsm.app.utils.*
import com.allenlabsfsm.app.utils.AppUtils.Companion.isProfile
...
import com.allenlabsfsm.features.NewQuotation.*
import com.allenlabsfsm.features.NewQuotation.api.GetQuotRegProvider
import com.allenlabsfsm.features.NewQuotation.model.ViewDetailsQuotResponse
import com.allenlabsfsm.features.SearchLocation.SearchLocationFragment
import com.allenlabsfsm.features.SearchLocation.locationInfoModel
import com.allenlabsfsm.features.TA.ViewAllTAListFragment
import com.allenlabsfsm.features.achievement.AchievementFragment
import com.allenlabsfsm.features.activities.presentation.*
import com.allenlabsfsm.features.addAttendence.*
import com.allenlabsfsm.features.addAttendence.api.addattendenceapi.AddAttendenceRepoProvider
import com.allenlabsfsm.features.addAttendence.api.leavetytpeapi.LeaveTypeRepoProvider
import com.allenlabsfsm.features.addAttendence.model.GetReportToFCMResponse
import com.allenlabsfsm.features.addAttendence.model.GetReportToResponse
import com.allenlabsfsm.features.addAttendence.model.Leave_list_Response
import com.allenlabsfsm.features.addorder.presentation.AddOrderFragment
import com.allenlabsfsm.features.addshop.model.AddShopRequestData
import com.allenlabsfsm.features.addshop.model.AddShopResponse
import com.allenlabsfsm.features.addshop.presentation.AddShopFragment
import com.allenlabsfsm.features.addshop.presentation.OTPVerificationDialog
import com.allenlabsfsm.features.addshop.presentation.ScanImageFragment
import com.allenlabsfsm.features.addshop.presentation.ShowCardDetailsDialog
import com.allenlabsfsm.features.alarm.model.AlarmData
import com.allenlabsfsm.features.alarm.presetation.AttendanceReportFragment
import com.allenlabsfsm.features.alarm.presetation.PerformanceReportFragment
import com.allenlabsfsm.features.alarm.presetation.VisitReportDetailsFragment
import com.allenlabsfsm.features.alarm.presetation.VisitReportFragment
import com.allenlabsfsm.features.attendance.AttendanceFragment
import com.allenlabsfsm.features.attendance.api.AttendanceRepositoryProvider
import com.allenlabsfsm.features.attendance.model.AttendanceRequest
import com.allenlabsfsm.features.attendance.model.AttendanceResponse
import com.allenlabsfsm.features.averageshop.presentation.AverageShopFragment
import com.allenlabsfsm.features.avgorder.presentation.AverageOrderFragment
import com.allenlabsfsm.features.avgtimespent.presentation.AvgTimespentShopListFragment
import com.allenlabsfsm.features.beatCustom.TeamBeatListFragment
import com.allenlabsfsm.features.billing.presentation.AddBillingFragment
import com.allenlabsfsm.features.billing.presentation.BillingDetailsFragment
import com.allenlabsfsm.features.billing.presentation.BillingListFragment
import com.allenlabsfsm.features.changepassword.presentation.ChangePasswordDialog
import com.allenlabsfsm.features.chat.model.ChatListDataModel
import com.allenlabsfsm.features.chat.model.ChatUserDataModel
import com.allenlabsfsm.features.chat.model.GroupUserDataModel
import com.allenlabsfsm.features.chat.presentation.*
import com.allenlabsfsm.features.chatbot.presentation.ChatBotFragment
import com.allenlabsfsm.features.chatbot.presentation.ChatBotShopListFragment
import com.allenlabsfsm.features.chatbot.presentation.ReportsFragment
import com.allenlabsfsm.features.chatbot.presentation.SelectLanguageDialog
import com.allenlabsfsm.features.commondialog.presentation.CommonDialog
import com.allenlabsfsm.features.commondialog.presentation.CommonDialogClickListener
import com.allenlabsfsm.features.commondialogsinglebtn.AddFeedbackSingleBtnDialog
import com.allenlabsfsm.features.commondialogsinglebtn.CommonDialogSingleBtn
import com.allenlabsfsm.features.commondialogsinglebtn.OnDialogClickListener
import com.allenlabsfsm.features.commondialogsinglebtn.TermsAndConditionsSingleBtnDialog
import com.allenlabsfsm.features.dailyPlan.prsentation.AllShopListFragment
import com.allenlabsfsm.features.dailyPlan.prsentation.DailyPlanListFragment
import com.allenlabsfsm.features.dailyPlan.prsentation.PlanDetailsFragment
import com.allenlabsfsm.features.damageProduct.ShopDamageProductListFrag
import com.allenlabsfsm.features.damageProduct.ShopDamageProductSubmitFrag
import com.allenlabsfsm.features.dashboard.presentation.api.ShopVisitImageUploadRepoProvider
import com.allenlabsfsm.features.dashboard.presentation.api.dashboardApi.DashboardRepoProvider
import com.allenlabsfsm.features.dashboard.presentation.api.otpsentapi.OtpSentRepoProvider
import com.allenlabsfsm.features.dashboard.presentation.api.otpverifyapi.OtpVerificationRepoProvider
import com.allenlabsfsm.features.dashboard.presentation.api.unreadnotificationapi.UnreadNotificationRepoProvider
import com.allenlabsfsm.features.dashboard.presentation.getcontentlisapi.GetContentListRepoProvider
import com.allenlabsfsm.features.dashboard.presentation.model.ContentListResponseModel
import com.allenlabsfsm.features.dashboard.presentation.model.ShopVisitImageUploadInputModel
import com.allenlabsfsm.features.dashboard.presentation.model.UnreadNotificationResponseModel
import com.allenlabsfsm.features.device_info.presentation.DeviceInfoListFragment
import com.allenlabsfsm.features.distributorwiseorder.DistributorwiseorderlistFragment
import com.allenlabsfsm.features.document.DocumentRepoFeatureNewFragment
import com.allenlabsfsm.features.document.presentation.DocumentListFragment
import com.allenlabsfsm.features.document.presentation.DocumentTypeListFragment
import com.allenlabsfsm.features.document.presentation.OpenFileWebViewFragment
import com.allenlabsfsm.features.dymanicSection.presentation.AddDynamicFragment
import com.allenlabsfsm.features.dymanicSection.presentation.AllDynamicListFragment
import com.allenlabsfsm.features.dymanicSection.presentation.DynamicListFragment
import com.allenlabsfsm.features.dymanicSection.presentation.EditDynamicFragment
import com.allenlabsfsm.features.gpsDisabilityScreen.GpsDisableFragment
import com.allenlabsfsm.features.home.presentation.HomeFragment
import com.allenlabsfsm.features.homelocation.presentation.HomeLocationFragment
import com.allenlabsfsm.features.homelocation.presentation.HomeLocationMapFragment
import com.allenlabsfsm.features.know_your_state.KnowYourStateFragment
import com.allenlabsfsm.features.lead.LeadFrag
import com.allenlabsfsm.features.lead.ViewLeadFrag
import com.allenlabsfsm.features.leaveapplynew.LeaveHome
import com.allenlabsfsm.features.leaveapplynew.model.clearAttendanceonRejectReqModelRejectReqModel
import com.allenlabsfsm.features.localshops.LocalShopListFragment
import com.allenlabsfsm.features.localshops.LocalShopListMapFragment
import com.allenlabsfsm.features.localshops.NearByShopsMapFragment
import com.allenlabsfsm.features.location.*
import com.allenlabsfsm.features.location.api.LocationRepoProvider
import com.allenlabsfsm.features.location.model.*
import com.allenlabsfsm.features.location.shopRevisitStatus.ShopRevisitStatusRepositoryProvider
import com.allenlabsfsm.features.location.shopdurationapi.ShopDurationRepositoryProvider
import com.allenlabsfsm.features.login.ShopFeedbackEntity
import com.allenlabsfsm.features.login.model.alarmconfigmodel.AlarmConfigDataModel
import com.allenlabsfsm.features.login.presentation.LoginActivity
import com.allenlabsfsm.features.logout.presentation.api.LogoutRepositoryProvider
import com.allenlabsfsm.features.logoutsync.presentation.LogoutSyncFragment
import com.allenlabsfsm.features.marketing.presentation.MarketingPagerFragment
import com.allenlabsfsm.features.meetinglist.prsentation.MeetingListFragment
import com.allenlabsfsm.features.member.MapViewForTeamFrag
import com.allenlabsfsm.features.member.model.TeamLocDataModel
import com.allenlabsfsm.features.member.model.TeamShopListDataModel
import com.allenlabsfsm.features.member.presentation.*
import com.allenlabsfsm.features.menuBeat.MenuBeatFrag
import com.allenlabsfsm.features.micro_learning.presentation.FileOpeningTimeIntentService
import com.allenlabsfsm.features.micro_learning.presentation.MicroLearningListFragment
import com.allenlabsfsm.features.micro_learning.presentation.MicroLearningWebViewFragment
import com.allenlabsfsm.features.myallowancerequest.MyallowanceRequestFragment
import com.allenlabsfsm.features.myjobs.model.CustomerDataModel
import com.allenlabsfsm.features.myjobs.presentation.*
import com.allenlabsfsm.features.myorder.presentation.MyOrderListFragment
import com.allenlabsfsm.features.myprofile.presentation.MyProfileFragment
import com.allenlabsfsm.features.nearbyshops.api.ShopListRepositoryProvider
import com.allenlabsfsm.features.nearbyshops.model.ShopData
import com.allenlabsfsm.features.nearbyshops.model.ShopListResponse
import com.allenlabsfsm.features.nearbyshops.multipleattachImage.MultipleImageFragment
import com.allenlabsfsm.features.nearbyshops.presentation.BeatListFragment
import com.allenlabsfsm.features.nearbyshops.presentation.NearByShopsListFragment
import com.allenlabsfsm.features.nearbyshops.presentation.NewNearByShopsListFragment
import com.allenlabsfsm.features.nearbyuserlist.presentation.NearbyUserListFragment
import com.allenlabsfsm.features.newcollection.CollectionDetailsStatusFragment
import com.allenlabsfsm.features.newcollection.CollectionShopListFragment
import com.allenlabsfsm.features.newcollection.NewCollectionListFragment
import com.allenlabsfsm.features.newcollectionreport.*
import com.allenlabsfsm.features.notification.NotificationFragment
import com.allenlabsfsm.features.orderList.NewDateWiseOrderListFragment
import com.allenlabsfsm.features.orderList.NewOrderListFragment
import com.allenlabsfsm.features.orderList.OrderListFragment
import com.allenlabsfsm.features.orderdetail.presentation.OrderDetailFragment
import com.allenlabsfsm.features.orderhistory.ActivityMapFragment
import com.allenlabsfsm.features.orderhistory.OrderhistoryFragment
import com.allenlabsfsm.features.orderhistory.TimeLineFragment
import com.allenlabsfsm.features.orderhistory.activitiesapi.LocationFetchRepositoryProvider
import com.allenlabsfsm.features.orderhistory.model.FetchLocationRequest
import com.allenlabsfsm.features.orderhistory.model.FetchLocationResponse
import com.allenlabsfsm.features.orderhistory.model.LocationData
import com.allenlabsfsm.features.pendinglocationinout.PendingOutLocationFrag
import com.allenlabsfsm.features.performance.GpsStatusFragment
import com.allenlabsfsm.features.performance.PerformanceFragment
import com.allenlabsfsm.features.performance.api.UpdateGpsStatusRepoProvider
import com.allenlabsfsm.features.performance.model.UpdateGpsInputParamsModel
import com.allenlabsfsm.features.performanceAPP.PerformanceAppFragment
import com.allenlabsfsm.features.permissionList.ViewPermissionFragment
import com.allenlabsfsm.features.photoReg.*
import com.allenlabsfsm.features.privacypolicy.PrivacypolicyWebviewFrag
import com.allenlabsfsm.features.quotation.presentation.*
import com.allenlabsfsm.features.reimbursement.presentation.*
import com.allenlabsfsm.features.report.presentation.*
import com.allenlabsfsm.features.returnsOrder.*
import com.allenlabsfsm.features.settings.presentation.SettingsFragment
import com.allenlabsfsm.features.shopFeedbackHistory.ShopFeedbackHisFrag
import com.allenlabsfsm.features.shopdetail.presentation.*
import com.allenlabsfsm.features.shopdetail.presentation.api.EditShopRepoProvider
import com.allenlabsfsm.features.stock.StockDetailsFragment
import com.allenlabsfsm.features.stock.StockListFragment
import com.allenlabsfsm.features.stockAddCurrentStock.AddShopStockFragment
import com.allenlabsfsm.features.stockAddCurrentStock.UpdateShopStockFragment
import com.allenlabsfsm.features.stockAddCurrentStock.ViewStockDetailsFragment
import com.allenlabsfsm.features.stockCompetetorStock.AddCompetetorStockFragment
import com.allenlabsfsm.features.stockCompetetorStock.CompetetorStockFragment
import com.allenlabsfsm.features.stockCompetetorStock.ViewComStockProductDetails
import com.allenlabsfsm.features.survey.SurveyFrag
import com.allenlabsfsm.features.survey.SurveyViewDtlsFrag
import com.allenlabsfsm.features.survey.SurveyViewFrag
import com.allenlabsfsm.features.task.presentation.AddTaskFragment
import com.allenlabsfsm.features.task.presentation.CalenderTaskFragment
import com.allenlabsfsm.features.task.presentation.EditTaskFragment
import com.allenlabsfsm.features.task.presentation.TaskListFragment
import com.allenlabsfsm.features.taskManagement.TaskManagementFrag
import com.allenlabsfsm.features.taskManagement.ViewTaskManagementFrag
import com.allenlabsfsm.features.timesheet.presentation.AddTimeSheetFragment
import com.allenlabsfsm.features.timesheet.presentation.EditTimeSheetFragment
import com.allenlabsfsm.features.timesheet.presentation.TimeSheetListFragment
import com.allenlabsfsm.features.viewAllOrder.CartFragment
import com.allenlabsfsm.features.viewAllOrder.OrderTypeListFragment
import com.allenlabsfsm.features.viewAllOrder.ViewAllOrderListFragment
import com.allenlabsfsm.features.viewAllOrder.ViewCartFragment
import com.allenlabsfsm.features.viewAllOrder.orderNew.NewOdrScrListFragment
import com.allenlabsfsm.features.viewAllOrder.orderNew.NewOrderScrActiFragment
import com.allenlabsfsm.features.viewAllOrder.orderNew.NewOrderScrOrderDetailsFragment
import com.allenlabsfsm.features.viewAllOrder.orderNew.NeworderScrCartFragment
import com.allenlabsfsm.features.viewAllOrder.orderOptimized.OrderProductCartFrag
import com.allenlabsfsm.features.viewAllOrder.orderOptimized.OrderProductListFrag
import com.allenlabsfsm.features.viewPPDDStock.ViewOutstandingFragment
import com.allenlabsfsm.features.viewPPDDStock.ViewPPDDListFragment
import com.allenlabsfsm.features.viewPPDDStock.ViewPPDDListOutstandingFragment
import com.allenlabsfsm.features.viewPPDDStock.ViewStockFragment
import com.allenlabsfsm.features.weather.presentation.WeatherFragment
import com.allenlabsfsm.mappackage.MapActivity
import com.allenlabsfsm.mappackage.MapActivityWithoutPath
import com.allenlabsfsm.mappackage.SendBrod
...
import com.allenlabsfsm.features.marketAssist.MarketAssistTabFrag
...
import com.allenlabsfsm.features.performanceAPP.allPerformanceFrag
...
//        val phototUri = Uri.parse(localAbsoluteFilePath)
            //val fileUrl = Uri.parse(File(Environment.getExternalStorageDirectory(), "xallenlabsfsmlogsample/log").path);
            //27-09-2021
//            val fileUrl = Uri.parse(File(Environment.getExternalStoragePublicDirectory(Environment.DIRECTORY_DOWNLOADS), "xallenlabsfsmlogsample/log").path);
...
//                BuildConfig.APPLICATION_ID+"/Log/Fsmlog.html").path);
            var currentDBPath="/data/user/0/com.allenlabsfsm/files/Fsmlog.html"
...
//        startActivity(Intent.createChooser(emailIntent,""))
    ...
    fun openShare(){
        try{
            ...
            val fileUrl1 = Uri.parse(File(Environment.getExternalStoragePublicDirectory(Environment.DIRECTORY_DOWNLOADS), "xallenlabsfsmlogsample/log").path);
            val fileUrl2 = Uri.parse(File(Environment.getExternalStoragePublicDirectory(Environment.DIRECTORY_DOWNLOADS), "xallenlabsfsmlogsample/log.bak.1").path);
...
//        return super.onCreateOptionsMenu(menu)
    ...
    fun generateNoteOnSD(context: Context?, sFileName: String?, sBody: String?) {
        try {
            val root =  File(Environment.getExternalStoragePublicDirectory(Environment.DIRECTORY_DOWNLOADS), "xallenlabsfsmlogsample/log" + ".txt")
            if (!root.exists()) {
                root.mkdirs()
            }
...
//        }
        val bytes = ByteArrayOutputStream()
//        bm!!.compress(Bitmap.CompressFormat.JPEG, 90, bytes)
        var destination = File(Environment.getExternalStoragePublicDirectory(Environment.DIRECTORY_DOWNLOADS), "xallenlabsfsmlogsample/log")
        val fo: FileOutputStream
        val fo1:FileWriter
        try {
            fo = FileOutputStream(destination)
